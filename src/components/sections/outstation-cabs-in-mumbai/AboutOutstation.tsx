            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8">
                <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
                    ...
                    <div className="w-full lg:w-1/2 relative h-[300px] sm:h-[400px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
                        <Image
                            src="/images/outstation-cabs-in-mumbai/phone-call-smile-business-man-car-travel-listening-journey-transport-cellphone-taxi-male-professional-calling-happy-communication-discussion-conversation-with-contact.avif"

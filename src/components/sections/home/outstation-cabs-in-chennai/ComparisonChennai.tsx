...
const ComparisonChennai = () => {
    const comparisons = [
        { feature: "Fare Transparency", fiesta: "Fixed quote, no hidden charges", agg: "Surge pricing applies" },
        { feature: "GST Invoice", fiesta: "Yes, every trip", agg: "Inconsistent" },
        { feature: "Driver Verification", fiesta: "Full background check", agg: "Variable by city" },
        { feature: "Vehicle Consistency", fiesta: "Confirmed type guaranteed", agg: "Vehicle type may change" },
        { feature: "Surge Pricing", fiesta: "None", agg: "Applies at peak times" },
        { feature: "One-Way Drops", fiesta: "Available, fixed inclusive fare", agg: "Limited on some platforms" },
        { feature: "Customer Support", fiesta: "24x7, phone and email", agg: "App-based, variable response" },
        { feature: "Booking Channels", fiesta: "Phone, email, website, app", agg: "App only on most platforms" },
    ];
            ...
            <div className="max-w-6xl mx-auto px-4 lg:px-8">
                ...
                <div className="mb-14 text-center max-w-3xl mx-auto">
                    ...
                    <p className="text-gray-600 text-lg leading-relaxed">
                        Users comparing outstation taxi services in Chennai will find the following differences between Fiesta and app-based aggregators.
                    </p>
                </div>
...
export default ComparisonChennai;

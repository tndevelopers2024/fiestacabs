    ...
    return (
        <section className="relative py-24 md:py-32">
            <div className="absolute inset-0 z-0">
                <Image
                    src="/images/corporate-car-rental-in-delhi/delhi-today.jpg"
                    alt="Book Car Rental in Delhi Today"
                    fill
            ...
            <div className="relative z-10 max-w-[1440px] mx-auto px-4 md:px-8">
                <div className="md:w-1/2 md:ml-auto text-white">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold mb-6 leading-tight text-white max-w-xl">
                        Book Car Rental in Delhi Today
                    </h2>

                    <p className="text-[15px] text-gray-200 mb-8 leading-[1.7] max-w-xl">
                        Fiesta makes it easy to book corporate car rental in Delhi quickly, whatever the trip. Share pickup details and travel needs with the team to enjoy hassle free travel across Delhi and the wider NCR.
                    </p>
